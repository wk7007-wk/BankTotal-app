...
- **임의 자동 변경 금지** — 돈 관련 데이터는 확실한 매칭만 자동적용, 불확실하면 사용자에게 선택지 제시
...
- **출금 보정** (checkSettleCorrection): confidence=high만 자동적용, low는 제안+적용버튼
...
## 정산 보정 원칙 (금액 관련 — 최우선)
- **확실한 매칭만 자동** — 거래상대와 항목명이 명확히 일치할 때만 자동 적용
- **불확실하면 제안** — 금액만 비슷하거나 이름 불확실 시 사용자에게 선택지 제시
- **임의 변경 절대 금지** — AI가 추정으로 금액/날짜를 바꾸면 안 됨
